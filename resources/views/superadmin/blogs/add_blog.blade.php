                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm"
                                        action="{{ route('superadmin.blogs.blog_store') }}">
                                        @csrf
                                        <div class="fpb-7">
                                            ...
                                            <input type="text" class="form-control eForm-control" id="blog_title"
                                                name="blog_title" maxlength="80" placeholder="Provide your blog title" required>
                                        ...
                                        <div class="fpb-7">
                                            ...
                                            <input type="text" class="form-control eForm-control" id="blog_subtitle"
                                                name="blog_subtitle" maxlength="80" placeholder="Provide your blog subtitle" required>
                                        ...
                                        <div class="fpb-7">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control eForm-control" id="blog_keywords"
                                                    name="blog_keywords[]"  data-role="tagsinput" placeholder="Enter your keywords"/>
                                        ...
                                        <div class="fpb-7">
                                            ...
                                            <input type="date" class="form-control eForm-control" id="blog_date"
                                                name="blog_date" maxlength="80" placeholder="Provide your blog date" required>
                                        ...
                                        <div class="fpb-7">
                                            ...
                                            <div class="form-group">
                                                ...
                                                name="blog_thumbnail" accept="image/*" required>
