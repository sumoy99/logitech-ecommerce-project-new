	                      ...
	                      <div class="eCard eCard-2">
	                        <div class="eCard-body">
	                          ...
	                          <div class="d-flex flex-column align-items-start align-items-md-center">
	                            <a href="javascript:void(0)" class="eBtn eBtn-blue" id="btn-<?php echo $phrase->id; ?>" onclick="updatePhrase('<?php echo $phrase->phrase; ?>', '{{ $current_editing_language }}', '<?php echo $phrase->id; ?>')">{{ get_phrase('Update') }}</a>
	                          </div>
	                        </div>
	                      </div>
	                    </div>
	...
	function updatePhrase(phrase, language, phrase_id) {
		...
		$.ajax({
			...
			success : function(response) {
				$('#btn-'+phrase_id).html('<i class = "bi bi-check-circle"></i>');
