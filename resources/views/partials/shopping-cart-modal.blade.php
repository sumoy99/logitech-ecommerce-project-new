...
<div class="wrap">
    @if($cartItems->isEmpty())
        <div class="tf-page-cart text-center mt_140 mb_200 mx-5">
                            ...
                            @if ($item->stock_status == 'In stock')
                                <div class="tf-mini-cart-item">
                                    <div class="tf-mini-cart-image">
                                        <a href="{{ route('frontend.product_details', ['product_slug' => $item->slug, 'id' => $item->id]) }}">
                                            <img src="{{ $item->thumbnail ? asset('assets/upload/products/thumbnails/' . $item->thumbnail) : asset('assets/backend/assets/img/placeholder.png') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <a class="title link" href="{{ route('frontend.product_details', ['product_slug' => $item->slug, 'id' => $item->id]) }}">{{ $item->name }}</a>
                                        <div class="meta-variant">Light gray</div>
                                        <div class="price fw-6">{{ currency($item->final_price) }}</div>
                                        <div class="tf-mini-cart-btns">
                                            ...
                                            <a href="{{route('frontend.customer.CartPrdRmv', ['id' => $item->id])}}"><div class="tf-mini-cart-remove">Remove</div></a>
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="tf-mini-cart-item">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        <a class="title link" href="{{ route('frontend.product_details', ['product_slug' => $item->slug, 'id' => $item->id]) }}">{{ $item->name }}</a>
                                        <div class="meta-variant">Light gray</div>
                                        <div class="price fw-6">Out Of stock</div>
                                        <div class="tf-mini-cart-btns">
                                            {{-- <div class="wg-quantity small">
                                                <span class="btn-quantity minus-btn">-</span>
                                                <input type="text" name="number" value="1">
            ...
            <div class="tf-mini-cart-bottom">
                ...
                <div class="tf-mini-cart-bottom-wrap">
                    <div class="tf-cart-totals-discounts">
                        ...
                        <div class="tf-totals-total-value fw-6">{{ currency($totalPrice) }}</div>
                    </div>
                    ...
                    <div class="tf-mini-cart-view-checkout">
                        <a href="{{route('frontend.customer.shopping_cart')}}"
                            class="tf-btn btn-outline radius-3 link w-100 justify-content-center">Check
                                out</a>
...
{{-- <div class="modal fade modalDemo popup-quickadd" id="quick_add">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" id="shopping-cart-content">
