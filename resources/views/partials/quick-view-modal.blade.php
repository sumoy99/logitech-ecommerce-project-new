...
<div class="wrap">
        ...
        <div dir="ltr" class="swiper tf-single-slide">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="item">
                        <img style="width: 100%" src="{{ $thumbnail ? asset('assets/upload/products/thumbnails/' . $thumbnail) : asset('assets/backend/assets/img/placeholder.png') }}" alt="">
                    </div>
                </div>
                @endif
                @foreach ($gallery_images as $gallery_image)
                    @if (!empty($gallery_image))
                        <div class="swiper-slide">
                            <div class="item">
                                <img src="{{ asset('assets/upload/products/gallery/' . $gallery_image) }}" alt="">
                            </div>
                        </div>
                    @endif
                @endforeach
    ...
    <div class="tf-product-info-wrap position-relative">
        <div class="tf-product-info-list">
            ...
            <div>
                <a href="{{ route('frontend.product_details', ['product_slug' => $product->slug, 'id' => $product->id]) }}" class="tf-btn fw-6 btn-line">View full details<i
